...
<!-- The gate parses this file by splitting on a bare "---" line: everything between the first
     and second "---" is the actual sendable letter. Keep that fence exactly as shown. -->
...
| Line in the note | JD pillar it answers | Grounded source |
|---|---|---|
| [ ] | [ ] | [ ] |

## Cards played

[mirrors resume/tailoring.md, for the letter specifically]

## Deliberately NOT said

[true-but-omitted claims and honest gaps NOT papered over, each with a one-line reason]
