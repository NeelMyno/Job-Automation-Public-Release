...
- `SETUP.md` — onboarding: what to fill in, in what order, and how much is truly required.
...
- `ops/` — this repo's own session record: `STATE.md`, `HANDOFF.md`, `decisions/` (an immutable ADR
