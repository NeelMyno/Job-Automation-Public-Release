...
Without `--write`, `crawl.py` prints its matches as JSON to stdout and touches nothing else —
useful if you just want the job list and plan to handle the rest yourself (see the companion
