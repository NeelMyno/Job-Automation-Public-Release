...
the scarce card. This file is the single source of truth for how many you have, where they went,
and when more arrive. **Any session that sends or recommends spending one updates this file in the
same turn.**

## Plan facts (fill in from your own plan's terms)
...
| As of | Credits left | Source |
|---|---|---|
| [YYYY-MM-DD] | [N] | [how you know] |

**Renewal:** [the Nth of every month, or your plan's actual cycle].
