...
`CLAUDE.md` §11 applies here as much as it does to anything you write down: no rehearsed-sounding
triads, no "passionate," nothing that would make a real interviewer's eyes glaze over.
...
- **S:** [The situation, 1-2 sentences of real context, just enough for a stranger to follow. Example
  shape: "Two days before a launch, a system the whole team depended on started failing
  intermittently, and nobody knew why yet."]
- **T:** [What was specifically on you, not "the team." Example shape: "I'd touched that part of the
  system most recently, so it fell to me to find the cause first."]
- **A:** [What you actually did, in enough real detail that a follow-up question doesn't expose that
  you're generalizing. Usually the longest of the four. Example shape: "I pulled the recent change
  history, isolated it to one specific dependency update, rolled that piece back to stop the
  bleeding, then wrote the real fix once the pressure was off instead of shipping something rushed."]
- **R:** [The real outcome, a number if you have one, and what changed afterward. Example shape: "The
...
<!-- A fact about you is a card: played only where it actually lands, never dealt to everyone by
...
<!-- A routing table: when a question or a company profile shows up, which story number do you reach
for first? Building this once means you're not deciding live, under pressure, in the interview. -->

| Question / situation | Story # |
|---|---|
| [ ] | [ ] |

## The two questions to always have answers for
