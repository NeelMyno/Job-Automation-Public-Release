...
many people can do both, which is usually why I end up [specific real consequence]."
-->

- [What's genuinely rare about your combination, and why it's rare]

## Frameworks & methods

<!--
Named methodologies or ways of working you actually use, not just know the name of.
-->
...
agent can quickly match "the JD wants X" against "do I actually have X."
-->
